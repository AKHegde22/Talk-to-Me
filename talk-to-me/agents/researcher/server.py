...
def create_server(agent_name: str, provider: str) -> Starlette:
    config = load_agent_config(agent_name)
    executor = LLMAgentExecutor(config, provider)
...
def main():
    app = create_server("researcher", "openai")
